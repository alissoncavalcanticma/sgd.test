<!-- Form -->
        ...
        <form action="../controller/AcessoController.class.php" method="get">
                            ...
                            <div class="row row_form" >
                                    ...
                                    <div class="row row_form"><!-- div row 2-->
                                        <!-- SOLICITANTE -->
                                        <div class="col-md-4">
                                ...
                                <div class="row row_form"><!-- div row 3-->
                                    <!-- MOTIVO -->            
                                    <div class="col-md-10">
                                        <label>Motivo:</label>
                                ...
                                <div class="row row_form"><!-- div row 4-->
                                    <!-- CHEGADA -->
                                    <div class="col-md-3">
                                            <label>Chegada:</label>
                                ...
                                <div class="row row_form"><!-- div row 5-->
                                    <!-- EQUIPAMENTO -->
                                    <div class="col-md-10">
                                ...
                                <div class="row row_form"><!-- div row 6-->
                                      <!-- SERVIÇO -->
                                      <div class="col-md-10">
                                          <label>Serviço:</label>
                                ...
                                <div class="row row_form"><!-- div row 7-->
                                      <!-- OBSERVAÇÃO -->
                                      <div class="col-md-10">
