...
<!--
<link rel="stylesheet" href="../assets/css/paginador.css" type="text/css" />
...
<!-- MENU SIDEBAR-->
                                        ...
                                        <form name="form_search" id="form_search" method="post" action="">
                                                <fieldset>
                                                        <div class="input-prepend">
                                                            ...
                                                            <input type="text" name="search" id="search" value="" tabindex="1" placeholder="Pesquisar..." />
                                                        </div>
                                                </fieldset>
                                        </form>
                                        </div>
        ...
        <script type="text/javascript">
                ...
                load_dados(null, 'acessos_inc.test.php', '#tbody');
                ...
                $('#search').keyup(function(){
                    ...
                    if($param.length >= 1)
                    {
                        load_dados(valores, 'acessos_inc.test.php', '#tbody');
